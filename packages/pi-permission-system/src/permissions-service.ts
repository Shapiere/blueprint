...
import type {
  ...
  PermissionPromptRendererRegistry,
} from "./authority/permission-prompt-renderer";
...
export class LocalPermissionsService implements PermissionsService {
  constructor(
    ...
    private readonly promptRendererRegistry: PermissionPromptRendererRegistry,
  ) {}
  ...
  ): ReturnType<PermissionsService["registerPermissionPromptRenderer"]> {
    return this.promptRendererRegistry.register(renderer);
  }
}
